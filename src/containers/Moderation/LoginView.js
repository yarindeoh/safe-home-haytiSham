...
import { useFiledChange, useLoginSubmit, useModerationStories } from './moderationHooks';
            ...
            <div id={'testimony-form'}>
                ...
                <form onSubmit={handleLogin}>
                    ...
                    <Input
                        ...
                        required
                    />
                    <input className="submit-button" type="submit" value={t('login.loginButtonText')}></input>
                </form>
            </div>
        }
        </div>
