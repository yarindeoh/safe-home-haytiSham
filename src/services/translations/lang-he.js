const he = {
    translation: {
        ...
        about: {
            header: 'מי אנחנו',
            noToViolanceIntro: 'עמותת “לא לאלימות” הוקמה בהרצליה על ידי כלת פרס ישראל הגב\' רות רזניק בשנת 1977 במטרה להציל נשים וילדיהן הסובלים מאלימות במשפחה ולאפשר להם לצאת לחיים חדשים באמצעות הענקת מקלט, טיפול מקצועי והכשרה מקצועית ולשמש להם פה לשינוי חקיקה והגברת המודעות בחברה לנושא האלימות במשפחה. פעילותה המרכזית של העמותה היא ניהול והפעלת 3  מקלטים לנשים הסובלות מאלימות ולילדיהן.',
            noToViolanceActions: 'כמו כן, מפעילה העמותה באמצעות מתנדבות קווי חירום הפועלים  24/7, ואת היחידה המשפטית המטפלת בהליכים המשפטיים של נשים במקלט ומתן ייעוץ משפטי ראשוני  לנשים הסובלות מאלימות ואינן זכאיות לסיוע משפטי.\n' +
            ...
            noToViolanceChange: 'במהלך השנים הצליחה העמותה להציל חיי נשים רבות ולהביא למהפך במודעות החברה הישראלית לתופעת האלימות במשפחה.',
            intro:
            ...
            volunteersNames:
                'מורן וובר<br/>לישי נועם<br/>ירין דקל<br/>מיכל פורג<br/>שחר גצוביץ׳<br/>נועה נובק<br/>אור מנור<br/>אורלי לבקוביץ פרנק<br/>הדס פרחי<br/>רומי ווינטר<br/>רותם שפרינגר<br/>יעל רמוס דר<br/>דניאל גרונת<br/>לאה גרונת',
