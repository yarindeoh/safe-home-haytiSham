const he = {
    translation: {
        ...
        about: {
            ...
            text4:
                ' של ״פוליטקלי קוראת״.<br/> האתר שהוקם מאגד עדויות ממערכות יחסים מתעללות, במטרה שיהווה בית לכל מי שרוצה לחלוק את הסיפור שלה או שלו, ולכל מי שרוצים ללמוד מהניסיון הזה הלאה. <br/> המטרה לאפשר הכרה עמוקה יותר של הדינמיקות המורכבות המלוות את מערכת היחסים המתעללת באמצעות ההזדהות עימן: רגעי ההבנה, ההתמודדות וההחלמה. האתר מבקש גם להראות שאלימות מגיעה במגוון של צורות, לא רק פיזית וקיימת בכל המגזרים באוכלוסייה. <br/> אתר נועד לאפשר מתן תמיכה, הקשבה וסיוע בזיהוי הסימנים המקדימים ולתת השראה לדרכי היציאה מהקשר לעבר חיים חדשים.  ',
            text5:
